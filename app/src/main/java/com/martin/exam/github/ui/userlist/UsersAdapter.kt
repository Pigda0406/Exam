...
import com.martin.exam.github.databinding.ListItemUsersBinding
import com.martin.exam.github.ui.main.MainFragmentDirections
...
class UsersAdapter : PagingDataAdapter<Users, UsersAdapter.UserViewHolder>(UserDiffCallback()) {
    ...
    class UserViewHolder(
        ...
        private fun navigateToUserInfo(
            ...
            val direction =
                MainFragmentDirections.actionNavigationUsersToNavigationUserInfo(user.login)
